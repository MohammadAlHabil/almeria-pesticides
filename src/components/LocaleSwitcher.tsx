...
export default function LocaleSwitcher() {
  ...
  return (
    ...
    <Select.Root
      ...
      disabled={isPending}
    >
      <Select.Trigger className="flex h-10 min-w-36 items-center justify-between gap-3 rounded-md border border-gray-200 pr-3 pl-3.5 select-none hover:bg-gray-100/10 focus-visible:outline focus-visible:-outline-offset-1 focus-visible:outline-gray-800 active:bg-gray-100 data-[popup-open]:bg-gray-100/10">
