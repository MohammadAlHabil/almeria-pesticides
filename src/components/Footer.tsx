      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <Link href="/" className="flex items-center mb-4 group">
              <div className="relative size-10 lg:size-12">
                <Image
                  ...
                  fill
                  className="object-contain brightness-0 invert transition-transform group-hover:scale-105"
                />
              </div>
              <div>
          ...
          <div>
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-lg font-medium transition-all duration-200 transform hover:scale-105 hover:shadow-lg text-sm group"
            >
              {t("footer.ctaButton")}
              <ArrowRight
